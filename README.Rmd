...
Once you have installed the package, you can see the different datasets included in a specific datacube in the {`manyenviron`} package using the following function.
