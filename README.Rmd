...
Manyenviron is a data package in the [qData](https://github.com/globalgov/qData) universe of many packages.
...
[`{manypkgs}`](https://github.com/globalgov/qData) includes a number of functions that make it easy
to create a new "many" package and populate with clean, consistent global governance data.

If you have any other ideas about how this package or the qData universe more broadly
