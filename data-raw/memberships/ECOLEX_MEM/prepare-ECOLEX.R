...
# Next run the following line to make ECOLEX_MEM available within the package.
manypkgs::export_data(ECOLEX_MEM, database = "memberships", URL = "https://www.ecolex.org/result/?type=treaty")
