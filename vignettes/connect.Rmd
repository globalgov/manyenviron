...
Let's look at treaties that either cite or amend the Ramsar Convention on Wetlands of International Importance Especially as Waterfowl Habitat ("RAMSA_1971A").
...
manyenviron::references$ECOLEX_REF %>%
  ...
  labs(title = "Treaties that cite or amend the Ramsar Convention 1971",
       caption = "Source: manyenviron") +
  theme_iheid()
```
...
Or we can look at countries part of environmental treaties for certain years.
...
manyenviron::memberships$IEADB_MEM %>%
  ...
  labs(title = "Countries part of environmental treaties signed into force in 1980",
