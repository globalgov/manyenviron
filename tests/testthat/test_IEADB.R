...
test_that("datasets have the required variables", {
  pointblank::expect_col_exists(agreements[["IEADB"]], vars(Title))
  pointblank::expect_col_exists(agreements[["IEADB"]], vars(Beg))
  expect_true(any(grepl("ID$", colnames(agreements[["IEADB"]]))))
  pointblank::expect_col_exists(agreements[["IEADB"]], vars(Signature))
})
