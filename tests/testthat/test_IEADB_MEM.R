...
test_that("dataset is arranged by the `Beg` variable", {
  expect_true(memberships[["IEADB_MEM"]]$Beg[1] <
                memberships[["IEADB_MEM"]]$Beg[10])
  expect_true(memberships[["IEADB_MEM"]]$Beg[50] <
                memberships[["IEADB_MEM"]]$Beg[75])
  expect_true(memberships[["IEADB_MEM"]]$Beg[100] <
                memberships[["IEADB_MEM"]]$Beg[120])
})
