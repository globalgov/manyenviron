...
#'
#' @format The agreements database is a list that contains the following 4 datasets: IEADB, GNEVAR, ECOLEX, CIESIN.
...
#' \item{CIESIN: }{A dataset with 666 observations and the following 4 variables: Title, Beg, Signature, Force.}
#' }
 "agreements"
