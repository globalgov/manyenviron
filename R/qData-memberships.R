...
#' 9 variables: ECOLEX_ID, Title, Country, Beg, End, SignatureC, Force,
#' Rat, qID.}
...
#' 10 variables: IEADB_ID, Country, Title, Beg, End, SignatureC, Signature,
#' Rat, Force, qID.}
#' \item{TFDD_MEM: }{A dataset with 2118 observations and the following 6
#' variables: TFDD_ID, Country, Title, Beg, Signature, qID.}
#' }
 "memberships"
