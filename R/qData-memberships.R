...
#'
#' @format The memberships database is a list that contains the following 3 datasets: IEA_MEM, GNEVAR_MEM, ECOLEX_MEM.
#' For more information and references to each of the datasets used, please use the report_data() function.
#'\describe{
#' \item{IEA_MEM: }{A dataset with 27410 observations and the following 5 variables: ID, Country, Title, Beg, End.}
