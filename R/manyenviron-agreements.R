...
#' following 6 datasets: IEADB, GNEVAR, ECOLEX, CIESIN, HEIDI, HUGGO.
...
#' 16 variables: manyID, Title, Beg, End, DocType, AgreementType, GeogArea, Signature, Force, Lineage, accessionC, accessionP, treatyID, gnevarID, TreatyText, Source.}
#' }
