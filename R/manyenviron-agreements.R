...
#' \item{HUGGO: }{A dataset with 3850 observations and the following
#' 49 variables: manyID, treatyID, Title, Beg, End, Signature, Force, DocType, AgreementType, GeogArea, gnevarID, verified, gengID, ecolexID, ieaID, DocValidUntilDate, Notes, Download, MEA_type, Ambit, Region, subject_ecolex, subject_iea, Keywords, Lineage, Sequence, AdoptedIn, Languages, Appendices, Depository, DepositoryURL, Published, Abstract, Website1, Website2, Secretariat, SecretariatURL, UNEP, Supersedes, References, EnabledBy, AmendedBy, Lit, Data, Coded, TreatyText, SourceText, Text, AbstractText.}
#' \item{AIGGO: }{A dataset with 7294 observations and the following
